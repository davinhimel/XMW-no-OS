...
# ADF4368 Vendor ID Test Script
# This script tests the ADF4368 vendor ID example on Linux SPI

echo "=== ADF4368 Vendor ID Test Script ==="
echo ""
...
if [ ! -r /dev/spidev0.0 ] || [ ! -w /dev/spidev0.0 ]; then
    ...
    echo ""
    echo "Running ADF4368 vendor ID test..."
    ./build/adf4368.out
fi
