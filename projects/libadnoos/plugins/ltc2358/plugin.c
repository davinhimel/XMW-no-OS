/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  LTC2358 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ltc2358/ltc2358.h"
...
{
	struct ltc2358_init_param *param = (struct ltc2358_init_param *)
		no_os_calloc(1, sizeof(struct ltc2358_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ltc2358_init_param *param = (struct ltc2358_init_param *)init_param;
	struct ltc2358_dev *dev = NULL;
	
	int32_t ret = ltc2358_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ltc2358_dev *dev = (struct ltc2358_dev *)device;
	return ltc2358_remove(dev);
}
