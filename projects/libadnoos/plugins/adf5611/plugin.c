/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADF5611 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/adf5611/adf5611.h"
...
{
	struct adf5611_init_param *param = (struct adf5611_init_param *)
		no_os_calloc(1, sizeof(struct adf5611_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adf5611_init_param *param = (struct adf5611_init_param *)init_param;
	struct adf5611_dev *dev = NULL;
	
	int32_t ret = adf5611_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adf5611_dev *dev = (struct adf5611_dev *)device;
	return adf5611_remove(dev);
}
