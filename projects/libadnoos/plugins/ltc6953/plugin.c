/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  LTC6953 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/ltc6953/ltc6953.h"
...
{
	struct ltc6953_init_param *param = (struct ltc6953_init_param *)
		no_os_calloc(1, sizeof(struct ltc6953_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ltc6953_init_param *param = (struct ltc6953_init_param *)init_param;
	struct ltc6953_dev *dev = NULL;
	
	int32_t ret = ltc6953_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ltc6953_dev *dev = (struct ltc6953_dev *)device;
	return ltc6953_remove(dev);
}
