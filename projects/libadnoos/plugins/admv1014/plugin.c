/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADMV1014 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/admv1014/admv1014.h"
...
{
	struct admv1014_init_param *param = (struct admv1014_init_param *)
		no_os_calloc(1, sizeof(struct admv1014_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct admv1014_init_param *param = (struct admv1014_init_param *)init_param;
	struct admv1014_dev *dev = NULL;
	
	int32_t ret = admv1014_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct admv1014_dev *dev = (struct admv1014_dev *)device;
	return admv1014_remove(dev);
}
