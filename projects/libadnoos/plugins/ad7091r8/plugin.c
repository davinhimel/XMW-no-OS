/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7091R8 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad7091r8/ad7091r8.h"
...
{
	struct ad7091r8_init_param *param = (struct ad7091r8_init_param *)
		no_os_calloc(1, sizeof(struct ad7091r8_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7091r8_init_param *param = (struct ad7091r8_init_param *)init_param;
	struct ad7091r8_dev *dev = NULL;
	
	int32_t ret = ad7091r8_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad7091r8_dev *dev = (struct ad7091r8_dev *)device;
	return ad7091r8_remove(dev);
}
