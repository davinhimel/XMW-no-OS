/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADM1177 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/adm1177/adm1177.h"
...
{
	struct adm1177_init_param *param = (struct adm1177_init_param *)
		no_os_calloc(1, sizeof(struct adm1177_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adm1177_init_param *param = (struct adm1177_init_param *)init_param;
	struct adm1177_dev *dev = NULL;
	
	int32_t ret = adm1177_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adm1177_dev *dev = (struct adm1177_dev *)device;
	return adm1177_remove(dev);
}
