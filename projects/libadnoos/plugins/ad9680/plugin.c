/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD9680 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad9680/ad9680.h"
...
{
	struct ad9680_init_param *param = (struct ad9680_init_param *)
		no_os_calloc(1, sizeof(struct ad9680_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad9680_init_param *param = (struct ad9680_init_param *)init_param;
	struct ad9680_dev *dev = NULL;
	
	int32_t ret = ad9680_jesd204_link_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad9680_dev *dev = (struct ad9680_dev *)device;
	return ad9680_remove(dev);
}
