/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD9144 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad9144/ad9144.h"
...
{
	struct ad9144_init_param *param = (struct ad9144_init_param *)
		no_os_calloc(1, sizeof(struct ad9144_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad9144_init_param *param = (struct ad9144_init_param *)init_param;
	struct ad9144_dev *dev = NULL;
	
	int32_t ret = ad9144_jesd204_link_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad9144_dev *dev = (struct ad9144_dev *)device;
	return ad9144_remove(dev);
}
