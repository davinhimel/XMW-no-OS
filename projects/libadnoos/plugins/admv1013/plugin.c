/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADMV1013 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/admv1013/admv1013.h"
...
{
	struct admv1013_init_param *param = (struct admv1013_init_param *)
		no_os_calloc(1, sizeof(struct admv1013_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct admv1013_init_param *param = (struct admv1013_init_param *)init_param;
	struct admv1013_dev *dev = NULL;
	
	int32_t ret = admv1013_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct admv1013_dev *dev = (struct admv1013_dev *)device;
	return admv1013_remove(dev);
}
