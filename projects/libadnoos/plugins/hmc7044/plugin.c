/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  HMC7044 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
{
	struct hmc7044_init_param *param = (struct hmc7044_init_param *)
		no_os_calloc(1, sizeof(struct hmc7044_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct hmc7044_init_param *param = (struct hmc7044_init_param *)init_param;
	struct hmc7044_dev *dev = NULL;
	
	int32_t ret = hmc7044_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct hmc7044_dev *dev = (struct hmc7044_dev *)device;
	return hmc7044_remove(dev);
}
