/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7293 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad7293/ad7293.h"
...
{
	struct ad7293_init_param *param = (struct ad7293_init_param *)
		no_os_calloc(1, sizeof(struct ad7293_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7293_init_param *param = (struct ad7293_init_param *)init_param;
	struct ad7293_dev *dev = NULL;
	
	int32_t ret = ad7293_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad7293_dev *dev = (struct ad7293_dev *)device;
	return ad7293_remove(dev);
}
