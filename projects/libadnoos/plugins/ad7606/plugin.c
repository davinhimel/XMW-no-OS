/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7606 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad7606/ad7606.h"
...
{
	struct ad7606_axi_init_param *param = (struct ad7606_axi_init_param *)
		no_os_calloc(1, sizeof(struct ad7606_axi_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7606_axi_init_param *param = (struct ad7606_axi_init_param *)init_param;
	struct ad7606_axi_dev *dev = NULL;
	
	int32_t ret = ad7606_axi_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad7606_axi_dev *dev = (struct ad7606_axi_dev *)device;
	return ad7606_remove(dev);
}
