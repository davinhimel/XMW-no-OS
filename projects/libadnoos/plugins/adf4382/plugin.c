/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADF4382 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/adf4382/adf4382.h"
...
{
	struct adf4382_init_param *param = (struct adf4382_init_param *)
		no_os_calloc(1, sizeof(struct adf4382_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adf4382_init_param *param = (struct adf4382_init_param *)init_param;
	struct adf4382_dev *dev = NULL;
	
	int32_t ret = adf4382_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adf4382_dev *dev = (struct adf4382_dev *)device;
	return adf4382_remove(dev);
}
