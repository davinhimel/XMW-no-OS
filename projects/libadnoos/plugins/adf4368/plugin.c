/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADF4368 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/adf4368/adf4368.h"
...
{
	struct adf4368_init_param *param = (struct adf4368_init_param *)
		no_os_calloc(1, sizeof(struct adf4368_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adf4368_init_param *param = (struct adf4368_init_param *)init_param;
	struct adf4368_dev *dev = NULL;
	
	int32_t ret = adf4368_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adf4368_dev *dev = (struct adf4368_dev *)device;
	return adf4368_remove(dev);
}
