/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD9523 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/ad9523/ad9523.h"
...
{
	struct ad9523_init_param *param = (struct ad9523_init_param *)
		no_os_calloc(1, sizeof(struct ad9523_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad9523_init_param *param = (struct ad9523_init_param *)init_param;
	struct ad9523_dev *dev = NULL;
	
	int32_t ret = ad9523_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad9523_dev *dev = (struct ad9523_dev *)device;
	return ad9523_remove(dev);
}
