/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADRF6780 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/adrf6780/adrf6780.h"
...
{
	struct adrf6780_init_param *param = (struct adrf6780_init_param *)
		no_os_calloc(1, sizeof(struct adrf6780_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adrf6780_init_param *param = (struct adrf6780_init_param *)init_param;
	struct adrf6780_dev *dev = NULL;
	
	int32_t ret = adrf6780_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adrf6780_dev *dev = (struct adrf6780_dev *)device;
	return adrf6780_remove(dev);
}
