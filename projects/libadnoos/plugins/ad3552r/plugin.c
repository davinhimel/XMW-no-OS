/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD3552R Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad3552r/ad3552r.h"
...
{
	struct ad3552r_init_param *param = (struct ad3552r_init_param *)
		no_os_calloc(1, sizeof(struct ad3552r_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad3552r_init_param *param = (struct ad3552r_init_param *)init_param;
	struct ad3552r_dev *dev = NULL;
	
	int32_t ret = ad3552r_axi_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad3552r_dev *dev = (struct ad3552r_dev *)device;
	return ad3552r_remove(dev);
}
