/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD3530R Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad3530r/ad3530r.h"
...
{
	struct ad3530r_init_param *param = (struct ad3530r_init_param *)
		no_os_calloc(1, sizeof(struct ad3530r_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad3530r_init_param *param = (struct ad3530r_init_param *)init_param;
	struct ad3530r_dev *dev = NULL;
	
	int32_t ret = ad3530r_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad3530r_dev *dev = (struct ad3530r_dev *)device;
	return ad3530r_remove(dev);
}
