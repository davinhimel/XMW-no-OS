/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  MAX31875 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/temperature/max31875/max31875.h"
...
{
	struct max31875_init_param *param = (struct max31875_init_param *)
		no_os_calloc(1, sizeof(struct max31875_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct max31875_init_param *param = (struct max31875_init_param *)init_param;
	struct max31875_dev *dev = NULL;
	
	int32_t ret = max31875_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct max31875_dev *dev = (struct max31875_dev *)device;
	return max31875_remove(dev);
}
