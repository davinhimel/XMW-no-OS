/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  MAX31855 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/temperature/max31855/max31855.h"
...
{
	struct max31855_init_param *param = (struct max31855_init_param *)
		no_os_calloc(1, sizeof(struct max31855_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct max31855_init_param *param = (struct max31855_init_param *)init_param;
	struct max31855_dev *dev = NULL;
	
	int32_t ret = max31855_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct max31855_dev *dev = (struct max31855_dev *)device;
	return max31855_remove(dev);
}
