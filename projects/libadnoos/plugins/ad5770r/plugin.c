/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD5770R Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad5770r/ad5770r.h"
...
{
	struct ad5770r_init_param *param = (struct ad5770r_init_param *)
		no_os_calloc(1, sizeof(struct ad5770r_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad5770r_init_param *param = (struct ad5770r_init_param *)init_param;
	struct ad5770r_dev *dev = NULL;
	
	int32_t ret = ad5770r_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad5770r_dev *dev = (struct ad5770r_dev *)device;
	return ad5770r_remove(dev);
}
