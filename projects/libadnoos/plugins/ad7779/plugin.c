/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7779 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad7779/ad7779.h"
...
{
	struct ad7779_init_param *param = (struct ad7779_init_param *)
		no_os_calloc(1, sizeof(struct ad7779_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7779_init_param *param = (struct ad7779_init_param *)init_param;
	struct ad7779_dev *dev = NULL;
	
	int32_t ret = ad7779_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad7779_dev *dev = (struct ad7779_dev *)device;
	return ad7779_remove(dev);
}
