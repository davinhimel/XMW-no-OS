/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD5754R Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad5754r/ad5754r.h"
...
{
	struct ad5754r_init_param *param = (struct ad5754r_init_param *)
		no_os_calloc(1, sizeof(struct ad5754r_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad5754r_init_param *param = (struct ad5754r_init_param *)init_param;
	struct ad5754r_dev *dev = NULL;
	
	int32_t ret = ad5754r_gpio_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad5754r_dev *dev = (struct ad5754r_dev *)device;
	return ad5754r_remove(dev);
}
