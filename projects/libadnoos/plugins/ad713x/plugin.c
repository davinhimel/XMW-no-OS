/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD713X Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad713x/ad713x.h"
...
{
	struct ad713x_init_param *param = (struct ad713x_init_param *)
		no_os_calloc(1, sizeof(struct ad713x_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad713x_init_param *param = (struct ad713x_init_param *)init_param;
	struct ad713x_dev *dev = NULL;
	
	int32_t ret = ad713x_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad713x_dev *dev = (struct ad713x_dev *)device;
	return ad713x_remove(dev);
}
