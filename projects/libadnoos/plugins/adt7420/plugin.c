/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADT7420 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/temperature/adt7420/adt7420.h"
...
{
	struct adt7420_init_param *param = (struct adt7420_init_param *)
		no_os_calloc(1, sizeof(struct adt7420_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adt7420_init_param *param = (struct adt7420_init_param *)init_param;
	struct adt7420_dev *dev = NULL;
	
	int32_t ret = adt7420_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adt7420_dev *dev = (struct adt7420_dev *)device;
	return adt7420_remove(dev);
}
