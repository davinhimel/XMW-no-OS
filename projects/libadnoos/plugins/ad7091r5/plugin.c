/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7091R5 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad7091r5/ad7091r5.h"
...
{
	struct ad7091r5_init_param *param = (struct ad7091r5_init_param *)
		no_os_calloc(1, sizeof(struct ad7091r5_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7091r5_init_param *param = (struct ad7091r5_init_param *)init_param;
	struct ad7091r5_dev *dev = NULL;
	
	int32_t ret = ad7091r5_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad7091r5_dev *dev = (struct ad7091r5_dev *)device;
	return ad7091r5_remove(dev);
}
