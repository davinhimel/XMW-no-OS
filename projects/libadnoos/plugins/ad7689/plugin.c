/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7689 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad7689/ad7689.h"
...
{
	struct ad7689_init_param *param = (struct ad7689_init_param *)
		no_os_calloc(1, sizeof(struct ad7689_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7689_init_param *param = (struct ad7689_init_param *)init_param;
	struct ad7689_dev *dev = NULL;
	
	int32_t ret = ad7689_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad7689_dev *dev = (struct ad7689_dev *)device;
	return ad7689_remove(dev);
}
