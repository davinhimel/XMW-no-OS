/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  LTC2672 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ltc2672/ltc2672.h"
...
{
	struct ltc2672_init_param *param = (struct ltc2672_init_param *)
		no_os_calloc(1, sizeof(struct ltc2672_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ltc2672_init_param *param = (struct ltc2672_init_param *)init_param;
	struct ltc2672_dev *dev = NULL;
	
	int32_t ret = ltc2672_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ltc2672_dev *dev = (struct ltc2672_dev *)device;
	return ltc2672_remove(dev);
}
