/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD5766 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad5766/ad5766.h"
...
{
	struct ad5766_init_param *param = (struct ad5766_init_param *)
		no_os_calloc(1, sizeof(struct ad5766_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad5766_init_param *param = (struct ad5766_init_param *)init_param;
	struct ad5766_dev *dev = NULL;
	
	int32_t ret = ad5766_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad5766_dev *dev = (struct ad5766_dev *)device;
	return ad5766_remove(dev);
}
