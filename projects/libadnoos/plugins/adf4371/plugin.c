/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADF4371 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/adf4371/adf4371.h"
...
{
	struct adf4371_init_param *param = (struct adf4371_init_param *)
		no_os_calloc(1, sizeof(struct adf4371_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adf4371_init_param *param = (struct adf4371_init_param *)init_param;
	struct adf4371_dev *dev = NULL;
	
	int32_t ret = adf4371_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adf4371_dev *dev = (struct adf4371_dev *)device;
	return adf4371_remove(dev);
}
