/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD4170 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad4170/ad4170.h"
...
{
	struct ad4170_init_param *param = (struct ad4170_init_param *)
		no_os_calloc(1, sizeof(struct ad4170_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad4170_init_param *param = (struct ad4170_init_param *)init_param;
	struct ad4170_dev *dev = NULL;
	
	int32_t ret = _ad4170_digif_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad4170_dev *dev = (struct ad4170_dev *)device;
	return ad4170_remove(dev);
}
