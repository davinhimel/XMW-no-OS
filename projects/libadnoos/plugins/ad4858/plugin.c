/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD4858 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad4858/ad4858.h"
...
{
	struct ad4858_init_param *param = (struct ad4858_init_param *)
		no_os_calloc(1, sizeof(struct ad4858_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad4858_init_param *param = (struct ad4858_init_param *)init_param;
	struct ad4858_dev *dev = NULL;
	
	int32_t ret = ad4858_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad4858_dev *dev = (struct ad4858_dev *)device;
	return ad4858_gpio_remove(dev);
}
