/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADAQ8092 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/adaq8092/adaq8092.h"
...
{
	struct adaq8092_init_param *param = (struct adaq8092_init_param *)
		no_os_calloc(1, sizeof(struct adaq8092_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adaq8092_init_param *param = (struct adaq8092_init_param *)init_param;
	struct adaq8092_dev *dev = NULL;
	
	int32_t ret = adaq8092_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adaq8092_dev *dev = (struct adaq8092_dev *)device;
	return adaq8092_remove(dev);
}
