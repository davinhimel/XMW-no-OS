/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD917X Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad917x/ad9172.h"
...
{
	struct ad9172_init_param *param = (struct ad9172_init_param *)
		no_os_calloc(1, sizeof(struct ad9172_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad9172_init_param *param = (struct ad9172_init_param *)init_param;
	struct ad9172_dev *dev = NULL;
	
	int32_t ret = ad9172_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad9172_dev *dev = (struct ad9172_dev *)device;
	return ad9172_remove(dev);
}
