/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  LTC2983 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/temperature/ltc2983/ltc2983.h"
...
{
	struct ltc2983_init_param *param = (struct ltc2983_init_param *)
		no_os_calloc(1, sizeof(struct ltc2983_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ltc2983_init_param *param = (struct ltc2983_init_param *)init_param;
	struct ltc2983_dev *dev = NULL;
	
	int32_t ret = ltc2983_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ltc2983_dev *dev = (struct ltc2983_dev *)device;
	return ltc2983_remove(dev);
}
