/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD5758 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad5758/ad5758.h"
...
{
	struct ad5758_init_param *param = (struct ad5758_init_param *)
		no_os_calloc(1, sizeof(struct ad5758_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad5758_init_param *param = (struct ad5758_init_param *)init_param;
	struct ad5758_dev *dev = NULL;
	
	int32_t ret = ad5758_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad5758_dev *dev = (struct ad5758_dev *)device;
	return ad5758_remove(dev);
}
