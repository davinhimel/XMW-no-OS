/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  ADF4030 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/frequency/adf4030/adf4030.h"
...
{
	struct adf4030_init_param *param = (struct adf4030_init_param *)
		no_os_calloc(1, sizeof(struct adf4030_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct adf4030_init_param *param = (struct adf4030_init_param *)init_param;
	struct adf4030_dev *dev = NULL;
	
	int32_t ret = adf4030_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct adf4030_dev *dev = (struct adf4030_dev *)device;
	return adf4030_remove(dev);
}
