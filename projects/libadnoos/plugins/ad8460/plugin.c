/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD8460 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/dac/ad8460/ad8460.h"
...
{
	struct ad8460_init_param *param = (struct ad8460_init_param *)
		no_os_calloc(1, sizeof(struct ad8460_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad8460_init_param *param = (struct ad8460_init_param *)init_param;
	struct ad8460_dev *dev = NULL;
	
	int32_t ret = ad8460_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
...
int32_t adnoos_remove_device(void *device)
{
	...
	struct ad8460_dev *dev = (struct ad8460_dev *)device;
	return ad8460_remove(dev);
}
