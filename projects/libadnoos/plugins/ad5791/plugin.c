/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD5791 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
{
	struct ad5791_init_param *param = (struct ad5791_init_param *)
		no_os_calloc(1, sizeof(struct ad5791_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad5791_init_param *param = (struct ad5791_init_param *)init_param;
	struct ad5791_dev *dev = NULL;
	
	int32_t ret = ad5791_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
