/***************************************************************************//**
 *   @file   plugin.c
 *   @brief  AD7799 Plugin for libadnoos (AUTO-GENERATED)
 *   @author libadnoos
********************************************************************************
...
#include "drivers/adc/ad7799/ad7799.h"
...
{
	struct ad7799_init_param *param = (struct ad7799_init_param *)
		no_os_calloc(1, sizeof(struct ad7799_init_param));
	if (!param)
		return NULL;
...
int32_t adnoos_init_device(void **device, void *init_param)
{
	...
	struct ad7799_init_param *param = (struct ad7799_init_param *)init_param;
	struct ad7799_dev *dev = NULL;
	
	int32_t ret = ad7799_init(&dev, param);
	if (ret != 0) {
		return ret;
	}
